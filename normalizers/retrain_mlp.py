...
key1_key2_pairs = [('linears.0.weight', 'linears.0.weight'), ('linears.0.bias', 'linears.0.bias'), ('linears.1.weight', 'linears.1.weight'), ('linears.1.bias', 'linears.1.bias')]
...
torch.save(model.state_dict(), fname[:-3] + "_retrained.pt")
