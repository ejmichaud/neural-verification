...
sequence of integers {0, 1, ..., 9} and the output at each sequence
...
def sample_palindrome(length):
    ...
    """
    characters = np.random.choice(list(range(10)), size=length).tolist()
...
if __name__ == "__main__":
    ...
    for i in tqdm(range(D)):
        ...
        background = torch.randint(0, 10, (10 - length,), dtype=torch.int8)
