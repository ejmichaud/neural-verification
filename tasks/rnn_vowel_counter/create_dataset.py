...
sequence of letters (to be represented as one-hot vectors of 
length 26) and the output at each sequence position is the number
of vowels seen so far in the sequence. Sequences are  of length 10.
