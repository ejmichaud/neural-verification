...
is the minimum value in the sequence seen up to and including
at that position. Sequences are lists of integers in [0, 100)
of length 10.
...
if __name__ == "__main__":
    ...
    for i in tqdm(range(10)):
        sequences_y[:, i] = sequences_x[:, :i+1].min(dim=1)[0]
