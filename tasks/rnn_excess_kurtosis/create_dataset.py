...
excess kurtosis of all the elements up to that point. Sequences are
of length 10.
...
if __name__ == "__main__":
    ...
    sum_xxxx = torch.cumsum(sequences_x**4, dim=1)
    sequences_y = (sum_xxxx/sum_1-4*sum_xxx*sum_x/sum_1**2+6*sum_xx*sum_x**2/sum_1**3-3*sum_x**4/sum_1**4)/(sum_xx/sum_1 - (sum_x/sum_1)**2)**2 - 3
