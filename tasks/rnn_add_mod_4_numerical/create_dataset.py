...
sequence of integers in [0, 4), and the output is the cumulative
sum mod 4. Sequences are of length 10.
...
if __name__ == "__main__":
    ...
    D = int(1e6)
    split = 0.8
    sequences_x = torch.randint(0, 4, (D, 10, 1), dtype=torch.int64)
    sequences_y = torch.cumsum(sequences_x, dim=1) % 4
