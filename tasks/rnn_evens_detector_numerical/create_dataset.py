...
sequence position is whether the current integer is even or not.
Yes/no = 1/0
...
if __name__ == "__main__":
    ...
    # we can use int8 to save memory since our max value is 10
    ...
    perfsqrs += sequences_x == 2
    perfsqrs += sequences_x == 4
    perfsqrs += sequences_x == 6
    perfsqrs += sequences_x == 8
