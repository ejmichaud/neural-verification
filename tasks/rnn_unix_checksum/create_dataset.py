...
bit sequence, and the output is the running value of the Unix CRC-32
checksum (coming from the command cksum) of the bits up to that
...
if __name__ == "__main__":
    ...
    D = int(1e4)
    split = 0.9
    generator = torch.Tensor(list(map(int, bin(0x104C11DB7)[2:])))
