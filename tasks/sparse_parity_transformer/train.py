...
if __name__ == '__main__':
    ...
    train_loader = HeterogeneousDataLoader(strings_train, answer_idxs_train, batch_size=512, shuffle=True)
    ...
    steps = 1500
    lr = 3e-5 # low learning rate helps with stability during phase transition
