...
dividend in base 2 reverse order, and the output is the quotient (div by 5)
in base 2 reverse order. For example, we have 1101110/101=0010110,
...
if __name__ == "__main__":
    ...
    for i in range(10):
        ...
        cumulant, remainder = cumulant % 5, cumulant // 5
