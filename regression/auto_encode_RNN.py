...
parser.add_argument('--ckpt', type=str, default='tasks', help='device')
...
'''
In the following, we try both Linear Autoencoder and GCD Autoencoder (trying different hyperparameters).
We keep the best integer lattice which has the minimal description length.
'''
# LinRNNautoencode
